...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    sum = 3 * abs(((opponent_score // 10) % 10) - player_score % 10)  
    return max(sum, 1)
    # END PROBLEM 2
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always_n_roll(score, opponent_score):
        return n
    return always_n_roll
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    n = 1
    while n <= 10:
        current_score = make_averaged(roll_dice, times_called)(n, dice)
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    actual_score = boar_brawl(score, opponent_score)
